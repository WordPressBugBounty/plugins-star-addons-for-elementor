<!-- Start Slider Four Area -->
<div class="slider-area style-four">
    <div class="banner-slider owl-carousel owl-theme" style="background-image: url(<?php echo esc_url( $settings['slider_bg_image']['url'] ); ?>)">
        ...
        <?php foreach (  $settings['slider'] as $item ) : ?>
            ...
            <div class="single-banner-slider-item" style="background-image: url(<?php echo esc_url( $item['slider_image']['url'] ); ?>)">
