<!-- Start Slider Six Area -->
<div class="slider-area style-six text-center">
    <div class="slider-carousel owl-theme owl-carousel owl-dots-none" style="background-image: url(<?php echo esc_url( $settings['slider_bg_image']['url'] ); ?>)">
        ...
        <?php foreach (  $settings['slider'] as $item ) : ?>
            ...
            <div class="slide-item">
                <div class="image-layer" style="background-image: url(<?php echo esc_url( $item['slider_image']['url'] ); ?>)"></div>
                        ...
                        <?php if( $item['show_btn'] == 'yes' ): ?>
                            <div class="btn-box">
                                <?php if( $item['button_text1'] != '' ): ?>
                                    <a href="<?php echo esc_url($btn_link1); ?>" <?php echo wp_kses_post( $target1 ); ?> <?php echo wp_kses_post( $nofollow1 ); ?> class="default-btn2 icon active"><i class='bx bx-plus-circle'></i><?php echo esc_html( $item['button_text1'] ); ?></a>
                                <?php endif; ?>
                                <?php if( $item['button_text2'] != '' ): ?>
                                    <a href="<?php echo esc_url($btn_link2); ?>" <?php echo wp_kses_post( $target2 ); ?> <?php echo wp_kses_post( $nofollow2 ); ?> class="default-btn2 icon"><i class='bx bx-plus-circle'></i><?php echo esc_html( $item['button_text2'] ); ?></a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
