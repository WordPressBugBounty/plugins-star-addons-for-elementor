<!-- Start Slider Ten Area -->
<div class="slider-area style-ten">
    <div class="home-banner" style="background-image: url(<?php echo esc_url( $settings['slider_bg_image']['url'] ); ?>)">
        <div class="home-banner-slider-area owl-carousel">
            ...
            <?php foreach (  $settings['slider'] as $item ) : ?>
                ...
                <div class="home-banner-single-slide" style="background-image: url(<?php echo esc_url( $item['slider_image']['url'] ); ?>)">
                            ...
                            <?php if( $item['show_btn'] == 'yes' ): ?>
                                <div class="banner-button-group">
                                    <?php if( $item['button_text1'] != '' ): ?>
                                        <a href="<?php echo esc_url($btn_link1); ?>" <?php echo wp_kses_post( $target1 ); ?> <?php echo wp_kses_post( $nofollow1 ); ?> class="default-button6"><?php echo esc_html( $item['button_text1'] ); ?><i class="fa fa-angle-right"></i></a>
                                    <?php endif; ?>
                                    <?php if( $item['button_text2'] != '' ): ?>
                                        <a href="<?php echo esc_url($btn_link2); ?>" <?php echo wp_kses_post( $target2 ); ?> <?php echo wp_kses_post( $nofollow2 ); ?> class="default-button6"><?php echo esc_html( $item['button_text2'] ); ?><i class="fa fa-angle-right"></i></a>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
