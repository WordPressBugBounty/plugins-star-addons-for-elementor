<!-- Start Slider Two Area -->
<div class="slider-area style-two">
    <div class="home-slider owl-carousel owl-theme" style="background-image: url(<?php echo esc_url( $settings['slider_bg_image']['url'] ); ?>)">
        ...
        <?php foreach (  $settings['slider'] as $item ) : ?>
            ...
            <div class="main-banner-area" style="background-image: url(<?php echo esc_url( $item['slider_image']['url'] ); ?>)">
