...
class Elementor_Portfolio_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
        return 'star-portfolio';
    }

	public function get_title() {
        return __( 'Portfolio', 'star-addons-for-elementor' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'  => __( 'Portfolio', 'star-addons-for-elementor' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'  => __( 'Our Recent Works', 'star-addons-for-elementor' )
            ]
        );
        ...
        $this->start_controls_section(
			'portfolio_content',
			[
				'label' => esc_html__( 'Portfolio Content', 'star-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT
			]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Select Portfolio Style', 'star-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Select Portfolio Column', 'star-addons-for-elementor' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_control(
            'order',
            [
                'label' => __( 'Portfolio Order By', 'star-addons-for-elementor' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::TEXT,
                'default'   => __('View All Portfolio', 'star-addons-for-elementor'),
                'condition' => [
                    'show_btn' => 'yes'
                ]
            ]
	...
	protected function render() {
        ...
        <?php if($settings['portfolio_item_style'] == 'grid') : 
            if( $settings['portfolio_item_column'] == 'column-1' ) :
                $portfolio_column = 'full-col col-lg-12 col-md-6 col-sm-12'; 
            elseif( $settings['portfolio_item_column'] == 'columns-2' ) :
                $portfolio_column = 'full-col col-lg-6 col-md-6 col-sm-12';
            elseif( $settings['portfolio_item_column'] == 'columns-3' ) :
                $portfolio_column = 'full-col col-lg-4 col-md-6 col-sm-12';
            elseif( $settings['portfolio_item_column'] == 'columns-4' ) :
                $portfolio_column = 'full-col col-lg-3 col-md-6 col-sm-12';
            endif; 
        endif;
        ...
        <section class="portfolio-area ptb-20">
            <div class="container-fluid"> 
                ...
                <?php elseif($settings['portfolio_item_style'] == 'slider') : ?>
                    <div class="portfolio-slider owl-carousel owl-theme">
                <?php endif; ?>
                    <?php while($post_array->have_posts()): $post_array->the_post(); ?>
                    <?php if($settings['portfolio_item_style'] == 'grid') : ?>
                        <div data-aos="fade-up" data-aos-duration="1600" class="<?php echo esc_attr( $portfolio_column ); ?>">
                    <?php elseif($settings['portfolio_item_style'] == 'slider') : ?>
                        <div class="portfolio-wrap">
                    <?php endif; ?>
                        <div class="single-portfolio">
                            <?php if( get_the_post_thumbnail_url() != '' ) : ?>
                                <a class="popup-btn" href="<?php echo get_the_post_thumbnail_url(get_the_ID() ); ?>">
                                    <img class="portfolio-img" src="<?php echo get_the_post_thumbnail_url(get_the_ID() ); ?>" alt="Image">
                                </a>
                            <?php endif; ?>
                            <div class="fancybox">
                ...
                <?php if( $settings['show_pagination'] == 'yes' && $settings['portfolio_item_style'] == 'grid' ): ?>
